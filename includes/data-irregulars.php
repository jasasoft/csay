<?php
/**
 * WordNet morphological exception list.
 *
 * Source: WordNet 3.x exception files (verb.exc, noun.exc, adj.exc),
 * loaded from the legacy CleverSay site's `exc` table.
 * WordNet is licensed under the WordNet 3.0 license, which permits
 * redistribution. See https://wordnet.princeton.edu/license-and-commercial-use
 *
 * Used by Search::apply_stemming() to handle irregular verb/noun forms
 * (wrote->write, mice->mouse, taken->take, admitted->admit, etc.)
 * that the rule-based suffix stripper cannot reduce. The lookup runs
 * BEFORE the suffix loop -- if a word appears here, the fix is used
 * directly and rule-based stripping is skipped.
 *
 * Generated from exc.sql in v4.37.4. Do not edit by hand. To regenerate:
 * see the build script in tools/build-irregulars.php (if present) or
 * pull a fresh WordNet exc dump and run the same conversion.
 *
 * @package CleverSay
 */
...
/**
 * Returns the irregular-form lookup table.
 *
 * @return array<string,string> Map of inflected form => base lemma.
 */
function cleversay_irregulars(): array {
    static $cache = null;
